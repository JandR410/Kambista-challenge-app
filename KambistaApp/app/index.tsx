            ...
            <View style={CommonStyles.container}>
                <View style={CommonStyles.contentContainer}>
                    <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}> {}
                        ...
                        <Input placeholder="Escribe tu nombre" value={nombre} onChangeText={setNombre} />
                        ...
                        <View style={{ flexDirection: 'row', marginBottom: 10, marginTop: 20 }}>
                            ...
                            <View style={{ marginStart: '14%' }}>
                                ...
                                <Input placeholder="Número Doc" value={numeroDoc} onChangeText={setNumeroDoc} keyboardType="numeric" style={{ width: '140%' }} />
                            </View>
                        </View>
                        ...
                        <Input placeholder="Número celular" value={celular} onChangeText={setCelular} keyboardType="phone-pad" />
                        ...
                        <CustomButton title="CONTINUAR" onPress={() => router.navigate('/casaDeCambio')} style={{ marginTop: 20, width: '100%', borderRadius: 7, backgroundColor: '#00E3C2' }} textColor='#060F26' />
                    </ScrollView>
